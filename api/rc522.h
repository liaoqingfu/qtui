...
//----------------- 2. 变量声明 -----------------------
extern unsigned char ucCardData[4];
extern unsigned char ucCardTmpData[4];

//----------------- 3. 函数声明 -----------------------
BYTE RC522_Reset(void);			//复位RC522
void RC522_AntennaOn(void);		//开启天线发射  
BYTE RC522_AutoReader(void);	//读卡信息
void RC522_AntennaOff(void);	//关闭天线发射
